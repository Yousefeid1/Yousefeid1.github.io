...
| كلمة المرور | `[محمي — يُعيَّن عند التثبيت]` |

### حسابات تجريبية لكل الأدوار
| الدور | البريد الإلكتروني | كلمة المرور |
|-------|------------------|-------------|
| محاسب | `accountant@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
| موظف مبيعات | `sales@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
| موظف مشتريات | `purchase@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
| موظف تصنيع | `production@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
| مدير تصنيع | `prodmgr@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
| مشرف تصنيع | `supervisor@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
| موظف لوجستيك | `logistics@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
| مدير قسم | `deptmgr@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
| موظف عادي | `employee@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
