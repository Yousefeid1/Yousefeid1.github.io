...
const ROLE_PAGES = {
  ...
  'مدير':            null,
  'محاسب':           ['dashboard', 'journal', 'accounts', 'trial-balance', 'payments', 'expenses', 'report-pl', 'report-bs', 'report-inventory', 'report-order-cost', 'cost-centers', 'checks', 'year-closing', 'recurring-entries', 'settings', 'notifications'],
  ...
  'مدير تصنيع':    ['dashboard', 'blocks', 'cutting', 'slabs', 'quality', 'manufacturing', 'cost-centers', 'products', 'report-inventory', 'notifications'],
  ...
  'مدير قسم':       ['dashboard', 'employees', 'activity-log', 'sales', 'customers', 'crm', 'export', 'report-pl', 'report-order-cost', 'sales-performance', 'commissions', 'notifications'],
...
const pageTitles = {
  ...
  'report-order-cost':     'تقرير تكلفة الأمر',
...
function showPage(pageName) {
  ...
  const renders = {
    ...
    'report-order-cost':     renderReportOrderCost,
  ...
  _refreshTimer = setTimeout(() => {
    ...
    if (!document.getElementById('app').classList.contains('hidden') && currentUser) {
      ...
      const renders = {
        ...
        'report-pl': renderReportPL, 'report-bs': renderReportBS,
        'report-inventory': renderReportInventory,
        'report-cashflow': renderReportCashFlow,
...
const _NAV_ALLOWED_PAGES = new Set([
  ...
  'products', 'expenses', 'report-pl', 'report-bs',
  'report-inventory', 'report-cashflow',
  'report-export-profit', 'report-inv-movement', 'report-order-cost', 'report-customer-credit',
